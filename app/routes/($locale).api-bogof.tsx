...
export async function loader({ request, context }: LoaderFunctionArgs) {
  ...
  try {
    ...
    console.error('Error fetching Buy Once Get One Free Collection products:', error);
    throw new Response('Failed to load Buy Once Get One Free Collection products', { status: 500 });
  }
}
