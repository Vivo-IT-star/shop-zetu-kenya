...
export async function loader({ request, context }: LoaderFunctionArgs) {
  ...
  try {
    ...
    if (!result.collection) {
      throw new Response('African Yuva collection not found', { status: 404 });
    }
    ...
    console.error('Error fetching African Yuva products:', error);
    throw new Response('Failed to load African Yuva products', { status: 500 });
  }
}
