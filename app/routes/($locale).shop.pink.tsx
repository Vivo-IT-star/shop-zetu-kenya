...
import {usePinkProducts} from '~/lib/contexts/ThinkPinkProductsContext';
...
export async function loader({context, request, params}: LoaderFunctionArgs) {
  // fetch collections
  // const result = await context.storefront.query(ShopPink_COLLECTIONS_QUERY);
...
async function loadCriticalData({context}: LoaderFunctionArgs) {
  ...
  const featuredProductIds = [
    'gid://shopify/Product/8964758339803',
    'gid://shopify/Product/8964762042587',
    'gid://shopify/Product/8918113779931',
    'gid://shopify/Product/8970006200539',
    'gid://shopify/Product/8969987129563',
    'gid://shopify/Product/8969987719387',
    'gid://shopify/Product/8964756177115',
    'gid://shopify/Product/8970008527067',
    'gid://shopify/Product/8868041064667',
    'gid://shopify/Product/8969975234779',
  ];
...
const ShopPink = () => {
  ...
  return (
    <div className="flex flex-col w-full">
      <div className="w-full mt-52 md:mt-48 lg:mx-4 ">
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
          {/* Image Section */}
          <div className="w-full z-10 lg:w-1/2">
            {/* Mobile Image */}
            <img
              src="https://cdn.shopify.com/s/files/1/0621/5162/2875/files/IMG_9765_-_Copy.jpg?v=1759842888"
              alt="Pink Collection Mobile"
              className="w-full h-auto object-cover rounded-lg block lg:hidden"
            />

            {/* Desktop Image */}
            <img
              src="https://cdn.shopify.com/s/files/1/0621/5162/2875/files/IMG_0844.jpg?v=1759842964"
              alt="Pink Collection Desktop"
              className="w-full h-auto object-cover rounded-lg hidden lg:block"
            />
          </div>

          {/* Text Section */}
          <div className="mx-6 md:mx-0 lg:w-2/3 ">
            <p className="text-base leading-relaxed max-w-2xl  text-white">
              💗 <strong>Wear Your Heart (and a Little Pink)</strong> <br />
              <br />
              — October isn’t shy; it shows up loud, full of purpose and
              blushing in pink. From ribbons to runways, it’s that month where
              fashion and feeling link arms for something a little deeper:
              ...
              fashion can be beautiful and meaningful at the same time.
              <br />
              <br />A percentage of all sales from this collection will go
              towards an organisation that supports breast cancer awareness and
              care. Because sometimes, the best statement piece isn’t what you
              wear — it’s what you stand for.{' '}
              <Link
                to="/blogs/news/💗-wear-your-heart-and-a-little-pink"
                className="font-bold text-blue-500"
              >
                Read More
              </Link>
              <br />
              <br /> ✨ <strong>Shop with heart. Share the love.</strong>
            </p>
          </div>
        </div>
      </div>
      ...
      {/* <div className="text-center bg-pink-500 font-semibold text-lg lg:text-2xl mt-8 lg:mt-0">
        TOP SELLING
      </div> */}
      ...
      <div className="flex flex-row gap-4 w-full min-h-screen relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-y-auto">
          ...
          <div className="md:hidden flex fixed items-center justify-between top-38 h-14 z-50 bg-white shadow-sm left-1/2 transform -translate-x-1/2 w-full max-w-lg px-4">
            <h1 className="text-lg font-bold truncate">Shop Pink</h1>
