...
import { useShopByBodyFitProducts } from '~/lib/contexts/ShopByBodyFitProductsContext';
...
import ShopByBodyFitHeroBanners from '~/components/ShopByBodyFitHeroBanners';
import { FiltersSidebar } from '~/components/RadixDesktopFilters';

export async function loader({context, request, params}: LoaderFunctionArgs) {
  // fetch collections
  // const result = await context.storefront.query(ShopByBodyFit_COLLECTIONS_QUERY);
           ...
           <div className="flex flex-row gap-4 w-full min-h-screen relative overflow-hidden">
             ...
             <div className="flex-1 flex flex-col overflow-y-auto">
               ...
               <div className="md:hidden flex fixed items-center justify-between top-38 h-14 z-50 bg-white shadow-sm left-1/2 transform -translate-x-1/2 w-full max-w-lg px-4">
                 <h1 className="text-lg font-bold truncate">Plus Size Curvy</h1>
