...
export async function loader({ request, context }: LoaderFunctionArgs) {
  ...
  try {
    ...
    if (!result.collection) {
      throw new Response('Shop By Body Fit collection not found', { status: 404 });
    }
    ...
    console.error('Error fetching Shop By Body Fit Collection products:', error);
    throw new Response('Failed to load Shop By Body Fit Collection products', { status: 500 });
  }
}
