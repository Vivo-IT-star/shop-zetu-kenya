...
export async function loader({ request, context }: LoaderFunctionArgs) {
  ...
  try {
    ...
    if (!result.collection) {
      throw new Response('Lizola collection not found', { status: 404 });
    }
    ...
    console.error('Error fetching Lizola products:', error);
    throw new Response('Failed to load Lizola products', { status: 500 });
  }
}
