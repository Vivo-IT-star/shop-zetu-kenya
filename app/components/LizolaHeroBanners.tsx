...
const banners = [
  //   {
  //     name: 'Mid Year Sale',
  //     imageDesktop: '/midyear-sale-desktop.webp',
  //     imageMobile: '/midyear-sale-mobile.webp',
  //     href: 'https://shopzetu.com/collections/sale-side-story',
  //   },

  {
    name: 'Lizola',
    imageDesktop:
      'https://cdn.shopify.com/s/files/1/0621/5162/2875/files/Lizola_Website_Banner_80010d57-8680-4d93-90d7-d46ef7c533d6.jpg?v=1755176590',
    imageMobile:
      'https://cdn.shopify.com/s/files/1/0621/5162/2875/files/Lizola_Mobile_Banner_7e6acfc6-ee5f-4ea0-81a7-182b7ff75bc6.jpg?v=1755176590',
    href: '#',
  },
];

const LizolaHeroBanners = () => {
...
export default LizolaHeroBanners;
