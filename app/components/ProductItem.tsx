...
export function ProductItem({
  ...
  return (
    ...
    >
      ...
      {displayImage && (
        <div className="relative overflow-hidden aspect-9/16 flex items-center justify-center">
          <Image
          ...
          {/* <span
            className="absolute -top-1 right-0 text-white text-xs font-bold rounded-full shadow"
            style={{zIndex: 2}}
          >
      ...
      <div className="flex items-center justify-center text-center">
        ...
        <h4 className="font-semibold line-clamp-2">{product.vendor}</h4>
        ...
        {/* <div className="flex text-center items-center gap-2">
          ...
          <small className="text-[#C20000] font-bold line-through">
            <Money
              data={{
                amount:
                  parseFloat(firstVariant?.compareAtPrice?.amount ?? '0') > 0
                    ? firstVariant?.compareAtPrice?.amount
                    : '0.00',
                currencyCode:
                  firstVariant?.compareAtPrice?.currencyCode ?? 'USD',
              }}
            />
          </small>
        </div> */}
