...
export function SearchResultsPredictive({
  ...
  // Default children render: collections first, then products, then others
  if (!children) return null;
  return (
    <>
      <SearchResultsPredictiveCollections
        term={term}
      ...
      <SearchResultsPredictiveProducts
        ...
        closeSearch={closeSearch}
      />
      {/* Optionally render other sections below */}
      <SearchResultsPredictiveArticles
        term={term}
        articles={items.articles}
        closeSearch={closeSearch}
      />
      <SearchResultsPredictivePages
        term={term}
        pages={items.pages}
        closeSearch={closeSearch}
      />
      <SearchResultsPredictiveQueries
        queries={items.queries}
        queriesDatalistId="predictive-search-queries"
      />
      <SearchResultsPredictiveEmpty term={term} />
    </>
  );
}
