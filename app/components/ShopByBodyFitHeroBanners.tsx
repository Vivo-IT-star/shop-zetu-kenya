...
const banners = [
...

  {
    name: 'Lizola',
    imageDesktop:
      'https://cdn.shopify.com/s/files/1/0621/5162/2875/files/Plus_ize_Website_Banner.jpg?v=1759922586',
    imageMobile:
      'https://cdn.shopify.com/s/files/1/0621/5162/2875/files/Plus_ize_Mobile_Banner.jpg?v=1759922586',
    href: '#',
  },
];

const ShopByBodyFitHeroBanners = () => {
...
export default ShopByBodyFitHeroBanners;
