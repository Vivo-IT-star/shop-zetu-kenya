...
export const FlashSaleProductsCarousel = ({products, className}: any) => {
  const activeFlashSale = getActiveFlashSale();
  ...
  return (
    <div
      className={cn(
        'relative max-w-7xl h-full px-6 md:px-12 mx-auto mt-12 md:mt-8',
        className,
      )}
    >
      {/* Header */}
      ...
      <div className="bg-black text-lime-500 pl-4 md:px-6 py-2 md:-mb-4 shadow-md flex flex-col md:flex-row md:items-center md:justify-between space-y-2 md:space-y-0">
        ...
        <div className="w-full flex items-center justify-between md:gap-6">
          <div className="flex items-center gap-3">
            ...
            {/* <span className="text-lg font-bold">Vivo 15th Anniversary Sale</span> */}
          ...
          <Link
            to={'/collections/second-tiktok-live-session-friday-12th-june'}
            className="!text-white hover:bg-flash-sale-foreground/10 font-semibold"
          >
